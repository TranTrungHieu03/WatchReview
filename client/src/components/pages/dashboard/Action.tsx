...
// }
//
// const Action: FC<ActionProps> = ({ brand }) => {
//     const queryClient = useQueryClient()
//     const [open, setOpen] = useState<boolean>(true)
//     // let deleteFn: ReturnType<typeof useMutation>
//     const deleteFn = useMutation({
//         mutationFn: () => deleteBrand(`/${id}`),
//         onSuccess: () => {
//             queryClient.invalidateQueries({ queryKey: ["brand-list", `brand-${id}`] })
//         }
//     })
//
//     const handleDelete = () => {
...
//                 {/*<div className={"bg-yellow-100 hover:bg-yellow-200"} onClick={handleOpenModelEdit}>*/}
//                 {/*    Edit*/}
//                 {/*</div>*/}
